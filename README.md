...
`LIVEKIT_KEY/LIVEKIT_KEY_FILE` | The API key or key file path for the LiveKit SFU | Yes
`LIVEKIT_SECRET/LIVEKIT_SECRET_FILE` | The secret or secret file path for the LiveKit SFU | Yes
